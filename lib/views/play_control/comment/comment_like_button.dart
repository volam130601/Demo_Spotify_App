...
class CommentLikeParentButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (commentLikes!.isNotEmpty) {
      CommentLike commentLike = commentLikes.firstWhere((item) => item.userId == _user!.uid, orElse: () => CommentLike());
      if (commentLike.id != null) {
        return Row(
          ...
          children: [
            InkWell(
              onTap: () {
                  CommentService.instance.dislikeOfParentByUserId(
      ...
      return Row(
        children: [
          InkWell(
            onTap: () {
              CommentService.instance.likeOfParentByUserId(comment: comment);
            },
            child: const Icon(
...
class CommentLikeChildButton extends StatelessWidget {
  CommentLikeChildButton({Key? key, required this.commentReply, required this.comment}) : super(key: key);
  final Comment comment;
    ...
    if (commentLikes!.isNotEmpty) {
      ...
      if (commentLike.id != null) {
        return Row(
          ...
          children: [
            InkWell(
              onTap: () {
                CommentService.instance.dislikeOfChildByUserId(commentReply: commentReply,
                    comment: comment, commentLike: commentLike);
              },
              child: const Icon(
                Ionicons.heart,
      ...
      return Row(
        children: [
          InkWell(
            onTap: () {
              CommentService.instance.likeOfChildByUserId(comment: comment,commentReply: commentReply);
            },
            child: const Icon(
              Ionicons.heart_outline,
              color: Colors.grey,
